...
import { HeroSkeleton, AboutUsSkeleton, StoreSkeleton, BookingSkeleton, ContactUsSkeleton, AdminPanelSkeleton, ProductDetailSkeleton, CheckoutSkeleton, ProfileSkeleton } from '../components/skeletons';
